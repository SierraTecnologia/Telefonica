            ...
            <?php dd($phone) ?>
                <tr>
                    ...
                    <td>
                        ...
                        <div class='btn-group'>
                            <a href="{!! route('root.phones.show', [$phone->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                            <a href="{!! route('root.phones.edit', [$phone->id]) !!}" class='btn btn-default btn-xs'><i class="fa fa-edit"></i> Edit</a>
