    ...
    @foreach($emails as $email)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('root.emails.show', [$email->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('root.emails.edit', [$email->id]) !!}" class='btn btn-default btn-xs'><i class="fa fa-edit"></i> Edit</a>
